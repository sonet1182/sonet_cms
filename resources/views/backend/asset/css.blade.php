...
<link rel="stylesheet" href="{{ asset("asset/backend/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css") }}">
<!-- Select2 -->
...
<link rel="stylesheet" href="{{ asset("asset/backend/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css") }}">
<!-- BS Stepper -->
