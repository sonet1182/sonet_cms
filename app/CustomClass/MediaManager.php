							...
							<div class="tab-content">
								<div class="tab-pane fade" id="upload<?php echo $library;?>">
									<div class="py-3">
										 ...
										 <form method="POST" enctype="multipart/form-data" class="uploadform" id="upload_image_form<?php echo $modalClass;?>" xaction="<?php echo route('media_store'); ?>" >
		...
		$(document).ready(function (e) {
			...
			$('#upload_image_form<?php echo $modalClass;?>').submit(function(event) {
					...
					$.ajax({
						...
						type:'POST',
						url: "<?php echo route('media_store'); ?>",
						data: formData,
						cache:false,
						contentType: false,
						processData: false,
